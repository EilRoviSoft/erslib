...
template<>
struct ers::string_traits<std::string> {
...
template<>
struct ers::string_traits<std::string_view> {
    static constexpr bool is_comptime = true;
...
template<>
struct ers::string_traits<const char*> {
    static constexpr bool is_comptime = true;
...
struct ers::string_traits<const char(&)[Size]> {
    static constexpr bool is_comptime = true;
