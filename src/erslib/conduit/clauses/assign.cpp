...
conduit::impl::AssignClause::AssignClause(std::string column, binder_t binder) :
    IClause(&slots::set),
    _column(std::move(column)),
    _binder(std::move(binder)) {
}

ers::Status conduit::impl::AssignClause::render(Context& ctx) const {
...
conduit::impl::Clause conduit::impl::clauses::assign_null(std::string column) {
